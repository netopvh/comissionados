...
class RegimeTrabController extends Controller
{
    ...
    public function store(Request $request)
    {
        try{
            ...
            return redirect()->route('comissionados.regime.index')->with('success','Registro inserido com sucesso!');
    ...
    public function show($id)
    {
        try {
            ...
            return redirect()->route('comissionados.regime.index')->with('errors','Nenhum registro localizado no banco de dados');
        }
    }
    ...
    public function update($id, Request $request)
    {
        try {
            ...
            return redirect()->route('comissionados.regime.index')->with('success','Registro atualizado com sucesso');
        } catch (\Exception $e) {
            return redirect()->route('comissionados.regime.index')->with('errors','Nenhum registro localizado no banco de dados');
        }
    }

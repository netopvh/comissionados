...
@section('page-header')
    <div class="page-header page-header-default page-header-sm" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
        ...
        {{ Breadcrumbs::render('comissionados.servidores.show') }}
    </div>
@stop
        ...
        <div class="col-md-12">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    @if(!empty($servidor->nomeconj))
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group">
                                    <label class="display-block">Nome do Conjuge:</label>
                                    <span class="text-bold">{{ $servidor->nomeconj }}</span>
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="text-right">
                        <a href="{{ route('comissionados.servidores.index') }}" class="btn btn-info legitRipple"><i
                                    class="icon-database-arrow"></i> Retornar</a>
                        <a href="/dashboard/servidores/{{ $servidor->id }}/edit" class="btn btn-primary legitRipple"

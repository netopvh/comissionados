...
@section('page-header')
    <div class="page-header page-header-default page-header-sm" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
        ...
        {{ Breadcrumbs::render('comissionados.servidores.edit') }}
    </div>
@stop
        ...
        <div class="col-md-12">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <form action="{{ route('comissionados.servidores.update',['id' => $servidor->id]) }}" id="formServidores" class="form-validate" method="POST" autocomplete="off">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <fieldset>

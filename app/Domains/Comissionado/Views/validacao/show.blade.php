    ...
    <div class="page-header page-header-default page-header-sm" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
        <div class="page-header-content">
            <div class="page-title">
                <h5><span class="text-semibold">Validar Servidor</span></h5>
            </div>
        </div>
        {{ Breadcrumbs::render('comissionados.validacao.show') }}
    </div>
@stop
            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div class="text-right">
                        ...
                        <form id="formValidacao" class="formValida" action="{{ route('comissionados.validacao.update',['id' => $servidor->id]) }}" method="POST">
                            <a href="{{ route('comissionados.validacao.index') }}" class="btn btn-info legitRipple">
                            ...
                            <button type="submit" id="btnNaoValida" class="btn btn-danger legitRipple">
                                <i class="icon-database-time2 position-right"></i> não validar
                            </button>
                            <button type="submit" id="btnValida" class="btn btn-primary legitRipple">

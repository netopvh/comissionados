...
@section('page-header')
    <div class="page-header page-header-default page-header-sm" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
        ...
        {{ Breadcrumbs::render('comissionados.secretarias.show') }}
    </div>
@stop
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <span class="text-bold">{{ $secretaria->descricao }}</span>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset>
                                ...
                                <table class="table table-condensed">
                                    ...
                                    <tbody>
                                       @if(count($secretaria->servidores))
                                            @foreach($secretaria->servidores as $servidor)
                                                <tr>

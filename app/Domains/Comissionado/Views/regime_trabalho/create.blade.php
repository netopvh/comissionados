...
@section('page-header')
    <div class="page-header page-header-default page-header-sm" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
        ...
        {{ Breadcrumbs::render('comissionados.regime.create') }}
    </div>
@stop
        ...
        <div class="col-md-5">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <form action="{{ route('comissionados.regime.store') }}" id="formSend" class="form-validate" method="POST" autocomplete="off">
                        {{ csrf_field() }}
                        <fieldset>
